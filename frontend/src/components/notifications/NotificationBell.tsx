...
import { BellIcon, CheckCircleIcon, ClockIcon, FolderIcon } from '../icons/Icons'
          ...
          <div className="flex items-center justify-between border-b border-slate-100 px-3 py-2.5">
            ...
            {unreadCount > 0 && (
              <button
                ...
                disabled={markingAll || isRefreshing}
              ...
              {loading && items.length === 0 ? (
                ...
                items.map((n, index) => (
                  <Fragment key={n.id}>
                    ...
                    <li
                      className={`px-3 py-3 text-sm transition-colors ${n.isRead ? 'bg-white' : 'bg-blue-50/50'}`}
                    >
                      ...
                      {!n.isRead && (
                        <button
                          ...
                          disabled={markingId === n.id || isRefreshing}

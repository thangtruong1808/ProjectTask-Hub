...
public interface ITaskRepository
{
    ...
    Task<IReadOnlyList<TaskItem>> GetAllForProjectManagerAsync(long userId, string? search, int? status, long? projectId, CancellationToken cancellationToken = default);
